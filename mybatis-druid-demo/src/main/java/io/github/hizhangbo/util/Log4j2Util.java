...
//    }
    ...
    private static ConfigurationBuilder<BuiltConfiguration> configuration() {
        ConfigurationBuilder<BuiltConfiguration> configuration
        ...
        addAppender(configuration);
        addLogger(configuration);
        addRootLogger(configuration);

        return configuration;
    }

    private static void addRootLogger(ConfigurationBuilder<BuiltConfiguration> configuration) {
    ...
    private static void addLogger(ConfigurationBuilder<BuiltConfiguration> configuration) {
    ...
    private static void addAppender(ConfigurationBuilder<BuiltConfiguration> configuration) {
        BuiltConfiguration build = configuration.build();
        build.addAppender(fileAppender(FILE_NAME));
        build.addAppender(consoleAppender());
    }
